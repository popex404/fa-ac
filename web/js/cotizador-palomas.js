(function () {
  ...
  /* ============================================================
     Cotizador especializado de Palomas — clon de
  ...
  var PAGE_SLUG = 'landing-palomas';

  var LBL = {
    indicio:   { 'guano':'acumulación de guano', 'arrullo':'arrullo persistente', 'nidos':'nidos visibles', 'canaletas':'canaletas tapadas' },
  ...
  var STEPS = [
    {
      ...
      options: [
        { value:'guano',     label:'Guano acumulado',   icon:'💩' },
        { value:'arrullo',   label:'Arrullo persistente', icon:'🔊' },
        { value:'nidos',     label:'Nidos visibles',    icon:'🪹' },
        { value:'canaletas', label:'Canaletas tapadas', icon:'🌧️' }
      ]
    },
    {
    ...
    {
      id: 'tamano', question: '¿Qué tamaño tiene el espacio a tratar?', subtitle: 'Tamaño aproximado de la zona afectada',
      options: [
  ...
  function buildWAPalomas(ans, contact, ref) {
    ...
    var msg     = intro + 'Necesito una visita técnica gratuita para palomas ' + loc + '(vi ' + indicio + '). ¿Cuándo me pueden visitar?';
  ...
  function createCotizador(widgetEl) {
    ...
    function renderResult() {
      ...
      var wa = buildWAPalomas(ans, state.contact, state.refCode);
      ...
      div.innerHTML =
        '<div class="cot-result-header">' +
          ...
          '<p class="cot-result-sub">El control de <strong>palomas</strong> requiere una inspección en terreno para darte un presupuesto exacto.</p>' +
        '</div>' +
        '<div class="cot-result-cards">' +
          ...
          '<div class="cot-result-card">' +
            ...
            '<span class="cot-card-value cot-card-value--sm">Evaluación de puntos de posada/anidación y sistema recomendado</span>' +
          '</div>' +
        '</div>' +
        '<div class="cot-result-disclaimer">' +
          '<strong>¿Por qué no hay precio online?</strong> El control de palomas se cotiza por metros lineales de malla/antiposada instalados. Sin ver tu propiedad no podemos darte un valor justo.' +
        '</div>' +
