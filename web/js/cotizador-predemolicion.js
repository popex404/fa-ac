(function () {
  ...
  /* ============================================================
     Cotizador especializado de Predemolición — clon de
  ...
  var PAGE_SLUG = 'landing-predemolicion';

  var LBL = {
    indicio:   { 'madera-antigua':'estructura de madera antigua', 'nido-avispas':'nido de avispas visible', 'certificado-obra':'necesita certificado para obra', 'sospecha-roedores':'sospecha de roedores' },
  ...
  var STEPS = [
    {
      id: 'indicio', question: '¿Qué necesitas revisar?', subtitle: 'Elige lo que más se parece a tu caso',
      options: [
        { value:'madera-antigua',     label:'Estructura de madera antigua', icon:'🏚️' },
        { value:'nido-avispas',       label:'Nido de avispas visible',      icon:'🐝' },
        { value:'certificado-obra',   label:'Certificado para obra',        icon:'📋' },
        { value:'sospecha-roedores',  label:'Sospecha de roedores',         icon:'🐁' }
      ]
    },
    {
      id: 'propiedad', question: '¿Qué tipo de inmueble se va a demoler?', subtitle: 'El espacio que necesita inspección',
      options: [
    ...
    {
      id: 'tamano', question: '¿Qué tamaño tiene la estructura?', subtitle: 'Tamaño aproximado a inspeccionar',
      options: [
  ...
  function datosBloque(ans, contact, ref) {
    ...
    return '\n\n--- DATOS DE COTIZACIÓN (PREDEMOLICIÓN) ---' +
           '\nRef: ' + ref +
  ...
  function buildWAPredemolicion(ans, contact, ref) {
    var indicio = LBL.indicio[ans.indicio] || ans.indicio;
    ...
    var msg     = intro + 'Necesito una inspección de predemolición ' + loc + '(' + indicio + '). ¿Cuándo me pueden visitar?';
  ...
  function createCotizador(widgetEl) {
    ...
    function renderResult() {
      ...
      var wa = buildWAPredemolicion(ans, state.contact, state.refCode);
      ...
      div.innerHTML =
        '<div class="cot-result-header">' +
          ...
          '<p class="cot-result-sub">La inspecci&oacute;n de <strong>predemolici&oacute;n</strong> requiere una visita en terreno para darte un presupuesto exacto.</p>' +
        '</div>' +
        '<div class="cot-result-cards">' +
          ...
          '<div class="cot-result-card">' +
            ...
            '<span class="cot-card-value cot-card-value--sm">Inspección estructural, informe fotográfico y certificado SEREMI</span>' +
          '</div>' +
        '</div>' +
        '<div class="cot-result-disclaimer">' +
          '<strong>¿Por qué no hay precio online?</strong> La inspección se cotiza según el tamaño y la accesibilidad de la estructura. Sin verla no podemos darte un valor justo.' +
        '</div>' +
