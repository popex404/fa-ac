...
- **Regla CSS crítica:** `styles.css` es la fuente de verdad de `.btn-primary` / `.btn-secondary` / `.btn-sistema`. Si se usan en subpáginas, deben estar TAMBIÉN en `subpages.css` (no se heredan).
